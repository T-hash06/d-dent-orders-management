...
9. **Switching presets** — Ask the user first: **reinstall**, **merge**, or **skip**?
   - **Reinstall**: `pnpm dlx shadcn@latest init --preset <code> --force --reinstall`. Overwrites all components.
...
pnpm dlx shadcn@latest init --defaults  # shortcut: --template=next --preset=base-nova
